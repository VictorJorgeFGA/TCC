...
\begin{itemize}
  ...
  \item Definir estratégias de otimização de desempenho da funcionalidade escolhida;
  \item Realizar o desenvolvimento de ajustes de acordo com as necessidades dos usuários chaves e envolvidos da plataforma;
  \item Priorizar caminhos de desenvolvimento aderentes às estratégias de desempenho levantadas;
  \item Testar a solução adotada e expor os ganhos de desempenho em relação à versão anterior da aplicação;
\end{itemize}