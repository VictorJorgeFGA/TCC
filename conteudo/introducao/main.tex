...
Este trabalho tem como objetivo explorar oportunidades de reestruturação de funcionalidades que apresentam gargalos de desempenho e que ainda não se adequam ao contexto em que a aplicação se encontra: utilização no cenário nacional seguindo diretrizes de plataformas governamentais brasileiras.
Será tomada como foco a funcionalidade de textos participativos, uma vez que existe a necessidade de realizar desenvolvimentos para cumprir requisitos funcionais levantados pelos \textit{stakeholders} e também de melhorias de desempenho.
Entende-se que os resultados e a metodologia deste trabalho, apesar de serem direcionados para a plataforma Brasil Participativo, sejam replicáveis para outras plataformas \textit{web} que utilizam do modelo arquitetural MVC, e, especialmente, \textit{Ruby on Rails}.
Os objetivos gerais, contudo, podem ser sumarizados da seguinte maneira:

\begin{itemize}
  \item Listar e discutir alguns dos principais problemas de desempenho da plataforma;
  \item Realizar o desenvolvimento de ajustes na ferramenta de textos participativos de acordo com as necessidades dos usuários chaves e envolvidos da plataforma;
