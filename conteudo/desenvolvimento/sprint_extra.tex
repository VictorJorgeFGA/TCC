\subsection {Sprint para Ajustes na Ferramenta de Cadastro de Usuários}
...
A fim de comparação, foi executado no ambiente produtivo do Brasil Participativo ambas as consultas SQL utilizadas no método \texttt{disambiguate} com o comando \texttt{EXPLAIN ANALYZE}.
