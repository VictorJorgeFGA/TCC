...
A versão anterior às modificações descritas neste trabalho utilizada para comparação nos testes é a \textit{tag} 1.5.0, que está disponível no respositório oficial do Brasil Participativo em \url{https://gitlab.com/lappis-unb/decidimbr/decidim-govbr/-/tags/1.5.0}.
...
A execução dos testes extremos da página de visualização do texto seguiu a configuração de 10 requisições com fator de paralelismo igual a 10. O resultado pode ser verificado na Tabela \ref{tab:teste-carga-extremo-visualizar-texto}
