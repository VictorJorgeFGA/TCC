...
Os testes consistirão em submeter sob carga as páginas de visualização do texto participativo e visualização do rascunho (edição do texto participativo), dado que estas foram as páginas que receberam o foco para otimização de desempenho neste trabalho.

Serão levantados dados para comparação com a realidade do cotidiano e os resultados dos testes apresentados pelo ApacheBench, trazendo a noção do impacto causado pelas modificações deste realizadas. Para trazer variabilidade nos testes, serão executados tanto os testes com volumetria de parágrafos histórica, quanto com volumetria de parágrafos extremas.
...
No cenário de visualização do texto participativo, não há engajamento notório de usuários na plataforma. As contribuições se limitam a algumas dezenas de comentários em todo o ciclo de vida do texto. Pode-se visualizar na Figura \ref{} uma consulta SQL utilizada para verificar o dia em que mais foram submetidas contribuições a textos participativos. Dessa forma, optou-se por manter o padrão de carga de teste utilizado na página de visualização do rascunho.
